...
BestAccelTime = 3.0919; % zobrat realnu hodntu lebo pilot nerobi nic
BestSkidpadTime = 4.0725;
BestAutocrossTime = 52.6651; %TV GEPD rear steering
BestEnduranceTime = 55.8714;
...
[timeEndurance,datandu] = runLaptime(car,"doubleTurn");

%% Autocross
car.discipline = "autoX";
[timeAutocross,dataAutocross] = runLaptime(car,"doubleTurn");
%% efficiency calc
